...
| `--logo, -l` | Logo 底图路径 | `~/Documents/前瞻客/logo和表情/前瞻客logo底图.png` |
...
- 风格词触发品牌声明 / 免责声明：风格提示词中的"权威/严谨与精密"等强力风格词会触发 NotebookLM 自动生成页脚品牌声明。**解决方案**：提示词中添加通用封杀令，禁止所有非标准页脚文字
- 通用封杀 / 页脚多余文字：NotebookLM 可能自行编造多种页脚内容（品牌声明、权威背书、保密声明、来源标注等），必须在提示词中明确禁止所有非标准免责声明的页脚文字
